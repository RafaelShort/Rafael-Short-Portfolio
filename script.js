...
const translations = {
    pt: {
        ...
        'sobre-p3':    'Minha trajetória combina <strong>desenvolvimento de software, pesquisa científica e liderança técnica</strong>: desenvolvi aplicações mobile (Flutter/Dart) como Coordenador de Desenvolvimento Mobile no IEEE Nordeste, presidi o Capítulo IEEE Computer Society UFBA e contribuí em projetos de Eletrônica de Potência, Controle e Sistemas Embarcados usando Matlab, PSIM, C e DSPs Texas Instruments.',
        'tag-automation':  'Automação',
        'info-location':   'Salvador, Bahia, Brasil',
        'info-job':        'Ford Motor Company – AI Developer',
        'info-msc':        'M.Sc. em Eng. da Computação – UFBA',
        ...
        'exp1-desc':  'Desenvolvimento de soluções de Inteligência Artificial com foco na integração de AI Agents em aplicações corporativas, em colaboração contínua com equipes globais. Setup e manutenção de pipelines CI/CD, versionamento via GitHub e documentação técnica.',
        'exp2-title': 'Feature System Researcher',
        'exp2-date':  'Jan 2025 – Abr 2026',
        'exp2-desc':  'Pesquisa e desenvolvimento de software na Features Team com foco em automação e integração de sistemas. Atuação no projeto PDL Alert, gerando significativa otimização de workflows com impacto global nos processos da empresa.',
        'exp3-title': 'Presidente',
        'exp3-date':  'Dez 2023 – Fev 2025',
        'exp3-desc':  'Liderança do Capítulo IEEE Computer Society UFBA, coordenação de equipe multidisciplinar de voluntários, organização de eventos técnicos, workshops e cursos, e construção de parcerias com empresas e comunidade acadêmica.',
        'exp4-title': 'Coordenador de Desenvolvimento Mobile',
        'exp4-date':  'Jan 2024 – Dez 2024',
        'exp4-desc':  'Coordenação do desenvolvimento e manutenção do aplicativo oficial da IEEE Seção Nordeste Brasil (Google Play Store), com desenvolvimento de features em Flutter/Dart e soluções backend em Node.js.',
        'exp5-title': 'Estagiário – Eficiência Energética & P&D',
        'exp5-date':  'Out 2022 – Out 2024',
        'exp5-desc':  'Análise técnica e de viabilidade de projetos, gestão de processos e suporte a iniciativas regulatórias do programa PROPEE da ANEEL. Estudos de iluminação (ABNT NBR 5101) e cálculos de Relação Custo-Benefício.',
        'exp6-title': 'Bolsista CNPq/PIBIC – Iniciação Científica',
        'exp6-date':  'Set 2021 – Set 2022',
        'exp6-desc':  'Desenvolvimento de um Emulador de Painel Fotovoltaico baseado em conversor Buck-Boost DC-DC com controle via DSP Texas Instruments F28379D. Simulação e validação em Matlab, PSIM e Typhoon HIL.',
        ...
        'proj2-title':  'PDL Alert',
        'proj2-desc':   'Otimização de fluxos de trabalho internos através de integração e automação entre sistemas corporativos via APIs, gerando significativa economia de tempo com impacto global nos processos da empresa.',
        'proj2-status': 'Concluído',
        'proj3-title':  'App IEEE Seção Nordeste Brasil',
        'proj3-desc':   'Aplicativo móvel oficial da IEEE Seção Nordeste Brasil disponível na Google Play Store, servindo membros e participantes de eventos em toda a região Nordeste, com backend em Node.js e arquitetura escalável.',
        'proj4-title':  'Emulador de Painel Fotovoltaico',
        'proj4-desc':   'Iniciação Científica: emulador baseado em conversor Buck-Boost DC-DC capaz de reproduzir o comportamento de painéis solares sob diferentes condições ambientais. Resultados validados com dados do fabricante via DSP F28379D.',
        'proj4-status': 'Concluído',
        ...
        'proj8-title':  'Jogo da Velha',
        'proj8-desc':   'Implementação clássica do Jogo da Velha em Python com interface gráfica desenvolvida com a biblioteca Tkinter.',
        'proj9-title':  'Teste de Velocidade de Digitação',
        ...
        'award1-desc':  'Reconhecimento pela excelência em liderança estudantil, contribuição técnica e trabalho voluntário no ecossistema IEEE como bolsista de Iniciação Científica e Webmaster do Capítulo PES UFBA.',
        'award2-title': 'Medalha & Menção Honrosa – OBAQ',
        'award2-from':  'UFBA · 2016, 2017 e 2018',
        'award2-desc':  'Medalha na Olimpíada Baiana de Química (OBAQ) em 2016 e Menção Honrosa em 2017 e 2018, demonstrando excelência em raciocínio lógico e fundamentos científicos.',
    ...
    en: {
        ...
        'sobre-p3':    'My background combines <strong>software development, scientific research and technical leadership</strong>: I developed mobile applications (Flutter/Dart) as Mobile Development Coordinator at IEEE Northeast, served as President of the IEEE Computer Society UFBA Chapter and contributed to Power Electronics, Control and Embedded Systems projects using Matlab, PSIM, C and Texas Instruments DSPs.',
        'tag-automation':  'Automation',
        'info-location':   'Salvador, Bahia, Brazil',
        'info-job':        'Ford Motor Company – AI Developer',
        'info-msc':        'M.Sc. in Computer Engineering – UFBA',
        ...
        'exp1-desc':  'Development of Artificial Intelligence solutions focused on integrating AI Agents into corporate applications, in continuous collaboration with global teams. Setup and maintenance of CI/CD pipelines, version control via GitHub and technical documentation.',
        'exp2-title': 'Feature System Researcher',
        'exp2-date':  'Jan 2025 – Apr 2026',
        'exp2-desc':  'Software research and development in the Features Team focused on automation and system integration. Worked on the PDL Alert project, generating significant workflow optimization with global impact on company processes.',
        'exp3-title': 'President',
        'exp3-date':  'Dec 2023 – Feb 2025',
        'exp3-desc':  'Leadership of the IEEE Computer Society UFBA Chapter, coordination of a multidisciplinary volunteer team, organization of technical events, workshops and courses, and building partnerships with companies and the academic community.',
        'exp4-title': 'Mobile Development Coordinator',
        'exp4-date':  'Jan 2024 – Dec 2024',
        ...
        'proj2-title':  'PDL Alert',
        'proj2-desc':   'Optimization of internal workflows through integration and automation between corporate systems via APIs, generating significant time savings with global impact on company processes.',
        'proj2-status': 'Completed',
        'proj3-title':  'IEEE Northeast Brazil Section App',
        'proj3-desc':   'Official mobile application of the IEEE Northeast Brazil Section available on the Google Play Store, serving members and event participants throughout the Northeast region, with a Node.js backend and scalable architecture.',
        'proj4-title':  'Photovoltaic Panel Emulator',
        'proj4-desc':   'Scientific research project: emulator based on a Buck-Boost DC-DC converter capable of reproducing the behavior of solar panels under different environmental conditions. Results validated against manufacturer data via DSP F28379D.',
        'proj4-status': 'Completed',
        ...
        'proj8-title':  'Tic-Tac-Toe Game',
        'proj8-desc':   'Classic Tic-Tac-Toe implementation in Python with a graphical interface built with the Tkinter library.',
        'proj9-title':  'Speed Typing Test',
        ...
        'award1-desc':  'Recognition for excellence in student leadership, technical contribution and volunteer work in the IEEE ecosystem as a Research Scholar and Webmaster of the PES UFBA Chapter.',
        'award2-title': 'Medal & Honorable Mention – OBAQ',
        'award2-from':  'UFBA · 2016, 2017 and 2018',
        'award2-desc':  'Medal at the Bahia Chemistry Olympiad (OBAQ) in 2016 and Honorable Mention in 2017 and 2018, demonstrating excellence in logical reasoning and scientific foundations.',
...
function getPhrases() {
    return translations[currentLang].phrases;
}
